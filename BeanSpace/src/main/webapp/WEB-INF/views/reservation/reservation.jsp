...
<head>
  ...
  <link type="text/css" rel="stylesheet" href="${contextPath}/resources/assets/css/reservation.css"> 
...
<div class="container">
  ...
  <form action="${contextPath}/reservation/reservation_confirm.do" method="post">
    <label for="parking-time">주차 시간</label>
    <input type="datetime-local" id="parking-time" name="ptime" onchange="setMinValue()">

    <label for="exit-time">출차 시간</label>
    <input type="datetime-local" id="exit-time" name="etime" onchange="setMinValue()">
    ...
    <div id="feeText" class="info" >
      결제 금액:
    </div>
    <div id="mileageText" class="info red">
      포인트 적립액: 결제금액 × 0.02
    </div>
