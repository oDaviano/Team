...
<body>
    <div class="container">
        ...
        <div class="signup-wrapper">
            <h1 class="signup-title">회원 정보 수정</h1>
            <form action="${contextPath}/member/modMember.do" method="post" class="signup-form">
                ...
                <!-- 가입하기 버튼 -->
                <button type="submit" class="btn signup-btn" id="signup-btn" style="display: none;">확인</button>
            </form>
        </div>
